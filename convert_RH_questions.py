...
def fetch_data_from_mongodb():     
    ...
    db = client['chat_bot'] 
    collection = db['question_entretien_a_poser'] 
...
append_nlu_file(mongo_data, 'data/nlu_RH.yml')

# Append data to existing stories file
append_stories_file(mongo_data, 'data/stories_RH.yml')

# Append data to existing rules file
append_rules_file(mongo_data, 'data/rules_RH.yml')

# Append data to existing domain file
append_domain_file(mongo_data, 'domain_RH.yml')